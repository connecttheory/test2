class ProjectsController < ApplicationController
  ...
  before_filter :confirm_logged_in, :except => [:list, :sublist, :subabout, :portfolio]
  before_filter :find_user, :except => [:list, :sublist, :subabout, :portfolio]
  ...
  def portfolio
  	@user = User.first
  	@projects = Project.order("projects.created_at ASC").visible
  end
